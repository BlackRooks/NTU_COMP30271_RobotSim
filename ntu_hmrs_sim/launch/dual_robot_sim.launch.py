...
def generate_launch_description():
    ...
    print(f'Set the world (default marsyard2020), e.g. ros2 launch ntu_hmrs_sim dual_robot_sim.launch.py world:=rubicon')
    ...
    ros_gz_config = os.path.join(ntu_hmrs_sim_share_dir, 'config', 'dual_robot_ros_gz_bridge.yaml')
